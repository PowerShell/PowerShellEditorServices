...
task SetupDotNet -Before Clean, Build, TestHost, TestServer, TestE2E {
    ...
    if ($script:dotnetExe -eq $null) {
        ...
        Invoke-WebRequest "https://raw.githubusercontent.com/dotnet/sdk/v$script:RequiredSdkVersion/scripts/obtain/dotnet-install.$installScriptExt" -OutFile $installScriptPath
